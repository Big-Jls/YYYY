...
particle totem_of_undying ~ ~1 ~ 0 0 0 0.5 100 force @a
...
execute if score @e[tag=random,limit=1] r matches 56..70 run summon ravager ~ ~ ~
execute if score @e[tag=random,limit=1] r matches 56..70 run summon ravager ~ ~ ~
execute if score @e[tag=random,limit=1] r matches 71..100 run summon hoglin ~ ~ ~
execute if score @e[tag=random,limit=1] r matches 71..100 run summon hoglin ~ ~ ~
execute if score @e[tag=random,limit=1] r matches 71..100 run summon hoglin ~ ~ ~
execute if score @e[tag=random,limit=1] r matches 71..100 run summon hoglin ~ ~ ~
execute if score @e[tag=random,limit=1] r matches 71..100 run summon hoglin ~ ~ ~
execute if score @e[tag=random,limit=1] r matches 101..120 run function y:y/ge_wolf
